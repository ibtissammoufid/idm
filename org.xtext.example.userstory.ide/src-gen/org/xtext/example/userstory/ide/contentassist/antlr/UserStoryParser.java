...
public class UserStoryParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UserStoryGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUsAccess().getActivity1Assignment_18_2(), "rule__Us__Activity1Assignment_18_2");
			...
			builder.put(grammarAccess.getUsTaskAccess().getNameAssignment_1(), "rule__UsTask__NameAssignment_1");
			builder.put(grammarAccess.getUsEventAccess().getIdAssignment_0(), "rule__UsEvent__IdAssignment_0");
			builder.put(grammarAccess.getUsEventAccess().getNameAssignment_1(), "rule__UsEvent__NameAssignment_1");
			builder.put(grammarAccess.getUsEventAccess().getTypeAssignment_2(), "rule__UsEvent__TypeAssignment_2");
