 ...
 * @generated
 */
public class ProcessImpl extends MinimalEObjectImpl.Container implements bpmn.Process {
	/**
	...
	protected EClass eStaticClass() {
		return BpmnPackage.Literals.PROCESS;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.PROCESS__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.PROCESS__NAME, oldName, name));
	}
	...
	public EList<Pool> getPool() {
		if (pool == null) {
			pool = new EObjectContainmentEList<Pool>(Pool.class, this, BpmnPackage.PROCESS__POOL);
		}
		return pool;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BpmnPackage.PROCESS__ID:
				return getId();
			case BpmnPackage.PROCESS__NAME:
				return getName();
			case BpmnPackage.PROCESS__POOL:
				return getPool();
		}
