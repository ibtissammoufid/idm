...
public class BpmnSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BpmnPackage.GATE_WAY: {
				...
				if (result == null) result = caseActivity(gateWay);
				if (result == null) result = caseObject(gateWay);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.SUB_PROCESS: {
				...
				if (result == null) result = caseProcess(subProcess);
				if (result == null) result = caseObject(subProcess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case BpmnPackage.ARTIFACTS: {
				...
				if (result == null) result = caseObject(artifacts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.POOL: {
				...
				if (result == null) result = caseObject(pool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.FLOW_OBJECT: {
				...
				if (result == null) result = caseObject(flowObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.OBJECT: {
				bpmn.Object object = (bpmn.Object)theEObject;
			...
			case BpmnPackage.OR: {
				OR or = (OR)theEObject;
				T result = caseOR(or);
				if (result == null) result = caseSplit(or);
				if (result == null) result = caseGateWay(or);
				if (result == null) result = caseActivity(or);
				if (result == null) result = caseObject(or);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.XOR: {
				...
				if (result == null) result = caseSplit(xor);
				if (result == null) result = caseGateWay(xor);
				if (result == null) result = caseActivity(xor);
				if (result == null) result = caseObject(xor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.DATA_OBJECT: {
				...
				if (result == null) result = caseArtifacts(dataObject);
			...
			case BpmnPackage.TEXT_ANNOTATION: {
				...
				if (result == null) result = caseArtifacts(textAnnotation);
				if (result == null) result = caseObject(textAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.JOIN: {
				...
				if (result == null) result = caseObject(join);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.SPLIT: {
				...
				if (result == null) result = caseGateWay(split);
				if (result == null) result = caseActivity(split);
				if (result == null) result = caseObject(split);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.SEQUENCE_FLOW: {
				...
				if (result == null) result = caseFlowObject(sequenceFlow);
				if (result == null) result = caseObject(sequenceFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.MESSAGE_FLOW: {
				...
				if (result == null) result = caseFlowObject(messageFlow);
				if (result == null) result = caseObject(messageFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.DATA_ASSOCIATION: {
				...
				if (result == null) result = caseFlowObject(dataAssociation);
				if (result == null) result = caseObject(dataAssociation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.TASK: {
				...
				if (result == null) result = caseObject(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BpmnPackage.DATA_STORE: {
				...
				if (result == null) result = caseArtifacts(dataStore);
				if (result == null) result = caseObject(dataStore);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseObject(bpmn.Object object) {
		return null;
	}
