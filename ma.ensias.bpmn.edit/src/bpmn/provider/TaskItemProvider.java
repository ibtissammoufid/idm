...
/**
 * This is the item provider adapter for a {@link bpmn.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends ActivityItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BpmnPackage.Literals.TASK__ARTIFACTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Task.class)) {
			case BpmnPackage.TASK__ARTIFACTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.TASK__ARTIFACTS,
				 BpmnFactory.eINSTANCE.createArtifacts()));
